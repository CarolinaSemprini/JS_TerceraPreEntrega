...
const detectarBotones =(data)=>{
    ...
    const cartModal = document.querySelector('.container');
...
const accionBotones=()=>{
    ...
    const btnComprar =document.querySelector('.fas fa-shopping-basket');
...
btnTodos.forEach(boton=>{
    boton.addEventListener("click",(e)=>{
        btnTodos.forEach(boton=>boton.classList.remove("active"));
